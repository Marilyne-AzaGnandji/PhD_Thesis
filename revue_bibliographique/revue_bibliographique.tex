...
En 2016, la production céréalière était de de 4\,567\,066 tonnes, soit près de 68\% de la production agricole (check ref:DGESS,2017). Les superficies emblavées
...
12.9\% et 4.64\% (DGESS,2017). L’activité agricole au
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \caption{Plante,graines du sorgho-Schéma plant de sorgho et en champ réel}
  \end{center}
\end{figure}
...
\og{}millet indien\fg{} en Asie,\og{}blé égyptien\fg{} au Moyen-Orient\ldots{}\footnote{https://jardinage.lemonde.fr/dossier-820-sorgho-sorghum-bicolor-cereale-sans-gluten.html}. Depuis des siècles, les peuples d’Afrique et d’Asie utilisent ses graines pour leur alimentation. Aujourd’hui, le
sorgho est cultivé sur tous les continents, sa domestication a vraisemblablement
eu lieu il y a plusieurs millénaires en Afrique et au Sud-est du Sahara.  On note en Afrique\,trois centres géographiques actifs dans la diversification du sorgho cultivé:
...
\begin{figure}%
  ...
  \caption{Représentation de plants de sorgho en champ réel}
   \label{fig-PlantDeSorgho}
\end{figure}

En champ réel les plants de sorgho se présentent ainsi (voir
Fig.~\ref{fig-PlantDeSorgho}
p.~\pageref{fig-PlantDeSorgho}).
...
%\begin{tabular}{|>{\raggedright}p{18mm}|>{centering\itshape}p{18mm}<{...}|>{\raggedleft}p{18mm}|}
   %\hline
...
La figure 4 illustre la classification (cladogramme) phylogénétique des Poaceae dont fait
...
1,2,3\cite{BARRO_KONDOMBO_2010}. Le S.bicolor est principalement autogame, mais une
...
%\begin{figure}%
 % \begin{center}
  % \includegraphics[width=18cm]{images/__}
 % \end{center}
  %\caption{____}
%\end{figure}
...
%De manière schématique, la figure 7 illustre l’association et la rotation culturale.
