...
%\begin{table}
 ...
 % \begin{tabular}{|l|c|r|p{4cm}|}
   % \hline
    %\multicolumn{1}{|c}{Localisation géographique} \\ \dl
    %\multicolumn{1}{|c}{Superficies} \\ \dl
   % \multicolumn{1}{|c}{Rendements} \\ \dl
  %   \multicolumn{1}{|c} {Production} \\ \dl
 %   & \multicolumn{2}{|c}{millions ha} & \multicolumn{2}{|c}{T/ha} & \multicolumn{2}{|c} {millions d% e tonnes} \\ \hline
 %   & 2015/16 (p.) & 2016/17 (est.) & 2015/16 (p.) & 2016/17 (est.) & 2015/16 (p.) & 2016/17 (est.) % \\ \dl
...
\cite{Ndakidemi}
%(Ndakidemi, 2005; Makoi et al, 2009).
